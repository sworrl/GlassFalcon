...
object Mavic2Auth {
    ...
    init {
        // Try plugin first (loads from local gitignored RSA_PRIVATE_KEY.pem).
        usePlugin = runCatching {
            @Suppress("UNCHECKED_CAST")
            val clazz = Class.forName("dev.glassfalcon.core.plugin.local.Mavic2AuthPlugin") as Class<Any>
            val method = clazz.getMethod("loadKeyFromFile", java.io.File::class.java)
            method.invoke(null, java.io.File(java.io.File("").absolutePath + "/RSA_PRIVATE_KEY.pem")) as Boolean
        }.getOrNull() ?: false

        if (usePlugin) {
            Log.i(TAG, "[+] Using Mavic2AuthPlugin for auth frames")
        } else {
            // Fallback: use hardcoded key (for builds without the plugin)
            val RSA_PRIVATE_KEY_B64 = ""
            try {
                ...
                Log.i(TAG, "[+] Fallback RSA key loaded from hardcoded value")
            } catch (e: Exception) {
                Log.e(TAG, "[-] Failed to load RSA key: ${e.message}")
            }
        }
    }
    ...
    fun generateFrame(): ByteArray {
        ...
        if (usePlugin) {
            return runCatching {
                @Suppress("UNCHECKED_CAST")
                val clazz = Class.forName("dev.glassfalcon.core.plugin.local.Mavic2AuthPlugin") as Class<Any>
                val method = clazz.getMethod("generateFrame")
                method.invoke(null) as ByteArray
            }.getOrElse {
                Log.w(TAG, "Plugin frame generation failed: ${it.message}")
                generateFrameFallback()
            }
        }
